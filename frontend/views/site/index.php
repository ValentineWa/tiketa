      ...
      <div class="col-md-3">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><i class="fa fa-map-marker maka" aria-hidden="true"></i>Kasarani,Naiorbi County.</p>
             </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><i class="fa fa-map-marker maka" aria-hidden="true"></i>Uhuru Park, Nairobi.</p>
...
<p><button type="button" class="btn btn-secondary baton rounded-0 mx-5 my-5">Know Us</button></p>
</div>
</div>
</div>
<!-- end -->
...
<div class="row colum">
  <div class="column ">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/about/ap-2.jpg">
   <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/about/ap-7.jpg">
  ...
  <div class="column">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/blog/details/details-pic.jpg">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/blog/details/bs-1.jpg">
 <!-- <img src="<?= Yii::$app->request->baseUrl ?>/images/blog/details/bs-3.jpg">
   <img src="<?= Yii::$app->request->baseUrl ?>/images/blog/blog-1.jpg"> -->

  </div>
  <div class="column">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/blog/blog-2.jpg">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/blog/blog-3.jpg">
  <!--<img src="<?= Yii::$app->request->baseUrl ?>/images/blog/blog-4.jpg">
   <img src="<?= Yii::$app->request->baseUrl ?>/images/blog/blog-5.jpg">
  -->
  </div>
  <div class="column">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/blog/large-item.jpg">
  <img class="categ" src="<?= Yii::$app->request->baseUrl ?>/images/discography/disco-1.jpg">
          ...
          <div class="row">
            ...
            <div class="col-md-4 tex">
             ...
             <!-- <div class="row">
              ...
              <p><button type="button" class="btn btn-outline baton btn-lg">Join Mailing List</button></p></div>
            <div class="col-md-4"></div>
